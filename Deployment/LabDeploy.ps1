...
$dir = "c:\Projects\adflab\Deployment"        #Working directory of where your LabDeploy.ps1 file is located
...
$location = "West US 2"                     #Geo location of resource group, resources will use this as well
